      ...
      {isLoading ? (
        ...
        <div className="mb-24">
          <h1 className="text-3xl  text-white">
            Search Results for{" "}
            <span className="text-3xl font-bold text-white">{query}</span>
          </h1>
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-row flex-wrap">
              {data.tracks.items.map((track: any, index: any) => {
                return (
                  <div
                    className="flex flex-row items-center justify-center bg-zinc-600 p-5 m-5 gap-5 "
                    key={index}
                  >
                    <div
              ...
              {data.artists.items.map((track: any, index: any) => {
                return (
                  <div
                    ...
                    key={index}
                    onClick={() => {
                      navigate(`/player/artist/${track.id}`);
                    }}
                  >
                    <div
                      className="flex flex-col items-center justify-center   rounded-lg"
